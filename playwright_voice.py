...
if __name__ == "__main__":
    try:
        browser_manager.start()
        agent_executor, _ = create_browser_agent()
        print("\nBrowser automation agent is ready. Speak your instructions. Say 'exit' to close the browser.")
        if sr is None:
            print("speech_recognition is not installed. Please run 'pip install SpeechRecognition pyaudio' to use voice input.")
            exit(1)
        ...
        while True:
            ...
            try:
                ...
                print("Sorry, could not understand your voice. Please try again.")
                continue
